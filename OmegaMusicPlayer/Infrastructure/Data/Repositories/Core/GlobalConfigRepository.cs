...
namespace OmegaMusicPlayer.Infrastructure.Data.Repositories
{
            ...
            await _errorHandlingService.SafeExecuteAsync(
                async () =>
                {
                    ...
                    else
                    {
                        ...
                        var newEntity = new OmegaMusicPlayer.Infrastructure.Data.Entities.GlobalConfig
                        {
                            LastUsedProfile = config.LastUsedProfile,
        ...
        public async Task<int> CreateDefaultGlobalConfig()
        {
            return await _errorHandlingService.SafeExecuteAsync(
                async () =>
                {
                    ...
                    var newConfig = new OmegaMusicPlayer.Infrastructure.Data.Entities.GlobalConfig
                    {
