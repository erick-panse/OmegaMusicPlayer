    ...
    public partial class LibraryView : UserControl
    {
            ...
            Dispatcher.UIThread.Post(() =>
            {
                ...
                catch (Exception ex)
                {
                    _errorHandlingService?.LogError(
                        ...
                        "Error during LibraryView initialization",
                        ex.Message,
                        ex,
                        false);
                }
        ...
        private void InitializeControls()
        {
            ...
            else
            {
                _errorHandlingService?.LogError(
                    ...
                    "Could not find TrackDisplayControl in LibraryView",
                    null,
                    false);
            }
        }
        ...
        private void FindTracksItemsControl()
        {
            try
            {
                ...
                if (_tracksItemsControl != null)
                {
                    ...
                    _cachedScrollViewer = this.FindControl<ScrollViewer>("TrackControlScrollViewer");
        ...
        private async void CheckVisibleItems(ScrollViewer scrollViewer)
        {
            ...
            try
            {
                ...
                {
                    scrollViewer = _cachedScrollViewer ?? this.FindControl<ScrollViewer>("TrackControlScrollViewer");
