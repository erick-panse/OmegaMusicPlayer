...
namespace OmegaPlayer.Features.Library.Views
{
    public partial class GenresView : UserControl
    {
        ...
        {
            if (_isDisposed || _layoutUpdatesPaused) return; // Don't process during resize
        ...
        protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
        {
            ...
            try
            {
                ...
                if (mainView != null)
                {
                    ...
                    _windowResizeHandler?.RegisterGenreView(this);
                }
            }
            catch (Exception ex)
            {
                _errorHandlingService?.LogError(ErrorSeverity.NonCritical, "Error registering GenresView with WindowResizeHandler", ex.Message, ex, false);
            }
        }
        ...
        public void OnResizeStarted()
        {
            ...
            {
                _errorHandlingService?.LogError(ErrorSeverity.NonCritical, "Error handling resize start in GenresView", ex.Message, ex, false);
            }
        }
        ...
        public void OnResizeCompleted()
        {
            ...
            {
                _errorHandlingService?.LogError(ErrorSeverity.NonCritical, "Error handling resize completion in GenresView", ex.Message, ex, false);
            }
        }
        ...
        protected override void OnDetachedFromVisualTree(VisualTreeAttachmentEventArgs e)
        {
            ...
            _windowResizeHandler?.UnregisterGenreView(this);
