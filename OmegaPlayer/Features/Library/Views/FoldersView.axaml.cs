...
namespace OmegaPlayer.Features.Library.Views
{
    public partial class FoldersView : UserControl
    {
        ...
        protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
        {
            ...
            try
            {
                ...
                if (mainView != null)
                {
                    ...
                    _windowResizeHandler?.RegisterFolderView(this);
                }
            }
            catch (Exception ex)
            {
                _errorHandlingService?.LogError(ErrorSeverity.NonCritical, "Error registering FoldersView with WindowResizeHandler", ex.Message, ex, false);
            }
        }
        ...
        private void OnDetachedFromVisualTree(object sender, VisualTreeAttachmentEventArgs e)
        {
            try
            {
                _windowResizeHandler?.UnregisterFolderView(this);
                _windowResizeHandler = null;
            }
            catch (Exception ex)
            {
                _errorHandlingService?.LogError(ErrorSeverity.NonCritical, "Error unregistering FoldersView from WindowResizeHandler", ex.Message, ex, false);
            }
        }
        ...
        public void OnResizeStarted()
        {
            ...
            {
                _errorHandlingService?.LogError(ErrorSeverity.NonCritical, "Error handling resize start in FoldersView", ex.Message, ex, false);
            }
        }
        ...
        public void OnResizeCompleted()
        {
            ...
            {
                _errorHandlingService?.LogError(ErrorSeverity.NonCritical, "Error handling resize completion in FoldersView", ex.Message, ex, false);
            }
        }
